...
When the captain invokes `/careen`, load the `careen` skill for its knowledge-routing haul-out; it never expands merge, destructive, or project-write authority.
