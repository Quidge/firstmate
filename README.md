...
| `/bearings`        | Generate a concise four-section fleet digest; add `file` for a dated report, `lavish` for an interactive fleet board, or `include PRs` for live PR enrichment |
